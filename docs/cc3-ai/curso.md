...
sesiones:
  ...
  - n: 5
    ...
    desc:
      - "Actividad: definir los objetivos del proyecto parcial."
      - "Los objetivos tienen jerarquía. Cuál va primero y cuál depende de otro que todavía no está resuelto."
      - "Empezamos por los primeros, que son estimaciones: cuántos dibujos, cuántas imágenes, cuántos cuadros."
      - "Un objetivo por prompt. Ej: Capas de procesamiento de una textura, La pantalla de inicio, el paso a la siguiente ventana y el puntaje final son tres."
      - "Describir el resultado perceptual: qué se ve y qué se oye, antes que cómo se programa."
      - "Un mismo objetivo se resuelve por caminos distintos. Vale la pena pedir dos y comparar."
      - "Lo que ya escribiste es contexto: el código que corre y las conversaciones anteriores."
